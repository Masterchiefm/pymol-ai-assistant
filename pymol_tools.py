            ...
            "function": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        "representation": {
                            "type": "string",
                            "description": "表示形式: lines, sticks, spheres, surface, mesh, ribbon, cartoon, dots, labels",
                            "enum": ["lines", "sticks", "spheres", "surface", "mesh", "ribbon", "cartoon", "dots", "labels"]
                        },
                        "selection": {
                            "type": "string",
            ...
            "function": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        "color": {
                            "type": "string",
                            "description": "颜色名称: red, green, blue, yellow, cyan, magenta, white, black, gray, orange, purple, pink, wheat, paleyellow, lightblue, salmon, lime, slate, hotpink, yelloworange, violet, grey, brown, or special: rainbow, by_element, by_chain"
                        },
                        "selection": {
                            "type": "string",
                            "description": "选择表达式（可选，默认 all）",
            ...
            "function": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        "color": {
                            "type": "string",
                            "description": "颜色名称: black, white, gray, grey, red, green, blue, yellow",
                            "default": "black"
                        }
                    },
                    "required": []
            ...
            "function": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "selection": {
                            "type": "string",
                            "description": "选择表达式，如 'chain A', 'resi 1-100', 'name CA', 'resn ASP'"
                        }
                    },
            ...
            "function": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "expression": {
                            "type": "string",
                            "description": "标签表达式，如 '%s' (残基名), '%i' (残基号), '%n' (原子名), '%a' (原子元素), '%ID' (ID), '%chain' (链), '%c' (链), '%r' (残基) 等",
                            "default": "%s%i"
                        }
                    },
                    "required": ["selection"]
